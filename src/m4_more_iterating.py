...
def run_test_count_positive_sines():
    ...
    # Test 11:
    expected = 5
    actual = count_positive_sines([1, 3, 5, 7, 9, 11, 13])
    print()
    print('Test 1 expected:', expected)
    print('       actual:  ', actual)
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = 18
    actual = sum_first_n([28, -10, 50000, 53839], 2)
    print()
    print('Test 1 expected:', expected)
    print('       actual:  ', actual)
    ...
    # Test 9:
    expected = 7050
    actual = sum_first_n([4800, 2200, 50, 5], 3)
    print()
    print('Test 1 expected:', expected)
    print('       actual:  ', actual)
